...
namespace PatientPortalBackend.Controllers
{
    ...
    public class MedimaxAllergyController : PortalBaseController
    {
        public MedimaxAllergyController(IHttpClientFactory httpClientFactory, IOptions<PortalSettings> portalSettings) : base(httpClientFactory, portalSettings)
        {
        }
