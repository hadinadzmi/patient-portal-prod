...
{
    public partial class BookAppointmentPageView : McComponentBase
    {
        ...
        private void CloseModal()
        {
            if (showSuccessModal)
            {
                // If it's a success modal, redirect to another page
            ...
            {
                // If it's an error modal, just close the modal
        ...
        private async Task HandleValidSubmit()
        {
            ...
            try
            {
                ...
                var request = new ServiceCreatePatientAppointmentRequest
                {
                    ...
                    AdditionalMsg = formModel.AdditionalMessage
                };
